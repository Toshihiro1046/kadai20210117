...
$stmt->bindValue(':evaluation', h($evaluation), PDO::PARAM_INT);        //Integer（数値の場合 PDO::PARAM_INT)
$stmt->bindValue(':movietype', h($movietype), PDO::PARAM_INT);        //Integer（数値の場合 PDO::PARAM_INT)
